...
//    对其中“教师评价：”这几个字进行翻转，其他字符不变，并且整句输出
    public void myreverse(String str4){
        StringBuilder stb=new StringBuilder(str4);
        int beg=stb.indexOf("教师评价:");
        System.out.println(stb.replace(beg, beg + 5, new StringBuilder(stb.substring(beg, beg + 5)).reverse().toString()));
    }
}
